...
const mockPosts = [
  {
    id: 101,
    imageUrl: "https://placehold.co/400x400/000000/FFFFFF?text=Post+1",
  },
  {
    id: 102,
    imageUrl: "https://placehold.co/400x400/31343C/FFFFFF?text=Post+2",
  },
  {
    id: 103,
    imageUrl: "https://placehold.co/400x400/929497/FFFFFF?text=Post+3",
  },
  {
    id: 104,
    imageUrl: "https://placehold.co/400x400/000000/FFFFFF?text=Post+4",
  },
  {
    id: 105,
    imageUrl: "https://placehold.co/400x400/31343C/FFFFFF?text=Post+5",
  },
  {
    id: 106,
    imageUrl: "https://placehold.co/400x400/929497/FFFFFF?text=Post+6",
  },
  {
    id: 107,
    imageUrl: "https://placehold.co/400x400/31343C/FFFFFF?text=Post+7",
  },
  {
    id: 108,
    imageUrl: "https://placehold.co/400x400/929497/FFFFFF?text=Post+8",
  },
];
    ...
    >
      ...
      >
        ...
        <div className="flex-grow p-6 space-y-6 overflow-y-auto">
          <div className="space-y-2">
            <h3 className="text-lg font-bold flex items-center gap-2">
              <span className="text-white bg-black rounded-full w-6 h-6 flex items-center justify-center text-sm">
                1
              </span>{" "}
              Select Posts
            </h3>
            <div className="flex flex-col sm:flex-row gap-2">
              <button
                onClick={() => setPostSelection("all")}
                className={`flex-1 text-center p-3 rounded-lg border border-dotted transition-colors ${
                  postSelection === "all"
              ...
              <button
                onClick={() => setPostSelection("future")}
                className={`flex-1 text-center p-3 rounded-lg border border-dotted transition-colors ${
                  postSelection === "future"
                    ? "bg-zinc-100 border-black"
                    : "border-zinc-300 hover:border-black"
                }`}
              >
              ...
              <button
                onClick={() => setPostSelection("specific")}
                className={`flex-1 text-center p-3 rounded-lg border border-dotted transition-colors ${
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div
                ...
                className="flex-1 p-4 border border-dotted rounded-lg cursor-pointer flex items-start gap-3 hover:border-black transition-colors bg-white"
              >
                {triggerType === "all_comments" ? (
                  <CheckCircle2 className="w-6 h-6 text-black flex-shrink-0 mt-0.5" />
                ) : (
                  <Circle className="w-6 h-6 text-zinc-400 flex-shrink-0 mt-0.5" />
                )}
                <div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-600">
                    Only reply if comment includes words.
                  </p>
                </div>
              </div>
            </div>
            {triggerType === "specific_keywords" && (
              <div className="pt-2">
                <input
                  ...
                  className="w-full p-2 bg-white border border-dotted border-zinc-400 rounded-lg focus:ring-1 focus:ring-black focus:border-black"
          ...
          <div className="space-y-2">
            ...
            <div className="p-4 border border-dotted rounded-lg bg-white flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-zinc-600">
                  Only reply to comments from your followers.
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  checked={followerCondition}
                  onChange={(e) => setFollowerCondition(e.target.checked)}
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <input
                    ...
                    className="w-32 p-2 bg-white border border-dotted border-zinc-400 rounded-lg focus:ring-1 focus:ring-black focus:border-black"
                    placeholder="e.g. 60"
                  />
                  <span className="text-sm text-zinc-600">seconds</span>
                </div>
                <p className="text-xs text-zinc-500 mt-1">
                  A delay makes replies feel more natural. Recommended: 30 -
                  3000 seconds.
                </p>
              </div>
              <div>
                ...
                <p className="text-xs text-zinc-600 mb-2">
                  One will be chosen at random to appear more natural.
                </p>
                  ...
                  {replies.map((reply, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-grow p-2 bg-white border border-dotted border-zinc-400 rounded-lg focus:ring-1 focus:ring-black focus:border-black"
                        placeholder={`Reply variation #${index + 1}`}
                      />
                      <button
                        onClick={() => removeReply(index)}
                        className="p-2 text-zinc-500 hover:text-red-500 hover:bg-zinc-100 rounded-full transition-colors flex-shrink-0"
                      >
                ...
                <button
                  onClick={addReply}
                  className="mt-3 px-3 py-1.5 border border-black rounded-lg flex items-center gap-2 hover:bg-zinc-100 transition-colors text-sm"
                >
        ...
        <div className="p-4 bg-white border-t border-dotted border-black flex-shrink-0">
          <button
            onClick={handleSave}
            className="w-full px-4 py-3 bg-black text-white rounded-lg hover:bg-zinc-800 transition-colors font-bold"
          >
            Save Rule
          </button>
        </div>
  ...
  const [rules, setRules] = useState([
    {
      ...
      replyDelay: 60,
      replies: [
        "Thanks for asking! We've sent you a DM with the details.",
        "Just sent you a DM with the pricing info!",
      ],
      isActive: true,
    },
    {
      ...
      triggerType: "all_comments",
      triggerKeywords: [],
      followerCondition: false,
      replyDelay: 2000,
      replies: ["Thanks for your comment! 🙌", "We appreciate you! ❤️"],
      isActive: false,
    },
  ]);
          ...
          >
            <div className="flex-grow">
              ...
              <div className="flex items-center gap-4 text-sm text-zinc-600 mt-1 flex-wrap">
                <span className="flex items-center gap-1.5">
                  ...
                  {rule.postSelection === "specific"
                    ? `${rule.selectedPostIds.length} Posts`
                    : rule.postSelection.replace(/^\w/, (c) =>
                        c.toUpperCase()
                      ) + " Posts"}
                </span>
                <span className="flex items-center gap-1.5">
                ...
                {rule.followerCondition && (
                  <span className="flex items-center gap-1.5">
                    <UserCheck className="w-4 h-4" /> Followers Only
                  </span>
                )}
                {rule.replyDelay > 0 && (
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-4 h-4" /> {rule.replyDelay}s Delay
                  </span>
                )}
              </div>
            </div>
            <div className="flex items-center gap-3 flex-shrink-0 self-end sm:self-center">
              ...
              <button
                ...
                className="p-2 text-zinc-500 hover:text-red-500 hover:bg-zinc-100 rounded-full transition-colors"
              >
                <Trash2 className="w-4 h-4" />
              </button>
            </div>
