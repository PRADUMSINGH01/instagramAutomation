...
const PostScheduler = () => {
  const [posts, setPosts] = useState([
    {
      id: 1,
      text: "Excited to announce our Q3 results! A big thank you to the entire team for their hard work.",
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h3 className="font-bold text-xl">Scheduled Posts</h3>
        <button
          onClick={handleNew}
...
const CommentRuleEditorPanel = ({ isOpen, rule, onSave, onClose }) => {
  ...
  const mockPosts = Array.from({ length: 8 }, (_, i) => ({
    ...
    ).toString(16)}/FFFFFF?text=Post+${i + 1}`,
  }));
      ...
      >
        ...
        <div className="flex-grow p-6 space-y-6 overflow-y-auto">
          <div className="space-y-2">
            <h3 className="text-lg font-bold">1. Select Posts</h3>
      ...
      <div className="flex flex-col h-full">
        ...
        <Card className="flex-grow flex flex-col items-center justify-center text-center border-2 border-dashed bg-zinc-50">
          ...
          <p className="text-zinc-600 mt-2 max-w-sm">
            To get started with scheduling posts and automating comments, you
            first need to connect your LinkedIn account.
          </p>
          <button
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="border-b border-dotted border-black mb-6">
        <nav className="flex gap-4 overflow-x-auto">
          {["Post Scheduler", "Comment Automation"].map((tab) => (
            <button
              key={tab}
