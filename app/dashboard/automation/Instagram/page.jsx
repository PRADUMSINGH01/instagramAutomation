...
import { FiMessageSquare, FiFileText, FiSend, FiSettings, FiPlus, FiFilter, FiSearch, FiX, FiChevronDown, FiActivity, FiUsers, FiBarChart2 } from 'react-icons/fi';
import { FaRegPauseCircle, FaRegPlayCircle, FaRegEdit, FaRegTrashAlt, FaRegCommentDots, FaRegPaperPlane } from 'react-icons/fa';
...
const AutomationDashboard = () => {
  ...
  const posts = [
    {
      ...
      content: 'Exploring how artificial intelligence is transforming digital marketing strategies.',
      date: '2023-10-15',
      likes: 245,
      comments: 32,
      platform: 'Twitter'
    },
    {
      ...
      content: 'Introducing our new summer collection with innovative features.',
      date: '2023-09-22',
      likes: 189,
      comments: 24,
      platform: 'Instagram'
    },
    {
      ...
      content: 'How we maintain a positive work environment in remote settings.',
      date: '2023-10-05',
      likes: 321,
      comments: 41,
      platform: 'LinkedIn'
  ...
  const handleCreateAutomation = () => {
    ...
    const newAutomation = {
      ...
      trigger: `${triggerType === 'keyword' ? 'Keyword' : 'Question type'}: "${triggerValue}"`,
      action: `${actionType === 'reply' ? 'Reply' : 'Send message'}: ${actionContent.substring(0, 20)}...`,
      status: 'active',
  ...
  const filteredAutomations = automations.filter(auto => auto.type === activeTab);
    ...
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-5 border-b border-gray-200">
          <h1 className="text-xl font-bold text-indigo-600">Social Automate</h1>
          <p className="text-xs text-gray-500 mt-1">Automate your social engagement</p>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white border-b border-gray-200 p-4 flex justify-between items-center">
          <h2 className="text-lg font-semibold capitalize">{activeTab} Automation</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Post</th>
                      <th className="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Trigger</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {filteredAutomations.map((auto) => (
                      <tr key={auto.id} className="hover:bg-gray-50">
                        <td className="py-4 px-6 text-sm font-medium text-gray-900">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-gray-500">Social Media Post</div>
                            </div>
                          </div>
                        </td>
                        <td className="py-4 px-6 text-sm text-gray-700">{auto.trigger}</td>
                        <td className="py-4 px-6 text-sm text-gray-700">{auto.action}</td>
                        ...
                        <td className="py-4 px-6 text-sm text-gray-500">{auto.date}</td>
              ...
              {filteredAutomations.length === 0 && (
                <div className="py-16 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-1">No comment automations yet</h3>
              ...
              <div className="px-4 py-3 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
                <div className="text-sm text-gray-700">
                  Showing <span className="font-medium">1</span> to <span className="font-medium">{filteredAutomations.length}</span> of{' '}
                  <span className="font-medium">{filteredAutomations.length}</span> results
                </div>
                <div className="flex space-x-2">
          ...
          {activeTab === 'post' && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Post Automation</h3>
                <p className="text-gray-600 max-w-md mx-auto mb-8">
                  Automate your social media posts. Schedule content, analyze performance, and optimize your posting strategy.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    ...
                    <h4 className="font-semibold text-gray-800 mb-2">Scheduled Posts</h4>
                    <p className="text-gray-600 text-sm">Create and schedule posts in advance for optimal engagement</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-600 text-sm">Target specific audience segments for each automated post</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-600 text-sm">Track engagement metrics and optimize your posting strategy</p>
                  </div>
                </div>
                <div className="mt-10">
          ...
          {activeTab === 'dms' && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Direct Message Automation</h3>
                <p className="text-gray-600 max-w-md mx-auto mb-8">
                  Automate your direct message responses. Engage with your audience instantly and efficiently.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    ...
                    <h4 className="font-semibold text-gray-800 mb-2">Auto Replies</h4>
                    <p className="text-gray-600 text-sm">Set up automatic replies to common questions and messages</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-600 text-sm">Capture leads through automated DM conversations</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                    <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 mb-4">
                      <FiActivity size={20} />
                    ...
                    <p className="text-gray-600 text-sm">Monitor response rates and engagement metrics</p>
                  </div>
                </div>
                <div className="mt-10">
                  <button className="px-6 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors">
                      ...
                      >
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-500 mt-1">{post.content.substring(0, 60)}...</div>
                            <div className="flex text-xs text-gray-500 mt-2">
                              <span className="mr-3">{post.date}</span>
                              <span className="mr-3">❤️ {post.likes} likes</span>
                      ...
                      {triggerType === 'keyword' ? (
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="availability">Availability questions</option>
                          </select>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="mb-4">
                      ...
                      <textarea 
                        ...
                        placeholder={`Enter your ${actionType === 'reply' ? 'reply' : 'message'} content here...`}
                        rows={4}
                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                      />
                    </div>
