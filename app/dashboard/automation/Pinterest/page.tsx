...
const Button: React.FC<ButtonProps> = ({
  ...
  const base = "inline-flex items-center justify-center rounded-xl font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed";
  
  const variants = {
    primary: "text-white bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 shadow-md hover:shadow-lg focus:ring-pink-500",
    secondary: "text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:ring-gray-400 shadow-sm",
    ghost: "text-gray-600 hover:bg-gray-100 focus:ring-gray-400",
    danger: "text-white bg-red-500 hover:bg-red-600 focus:ring-red-500 shadow-md hover:shadow-lg"
  };
...
const SectionHeader: React.FC<{ title: string; description?: string; right?: React.ReactNode }> = ({
  title,
  description,
  right,
}) => (
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-pink-500 to-purple-600 p-4">
      <Card className="max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-6">
          Connect your Pinterest account to start scheduling pins and auto‑replying to comments.
        </p>
...
const PinEditor: React.FC<PinEditorProps> = ({
  ...
  return (
    <>
      ...
      <SlideOver role="dialog" aria-modal="true" aria-labelledby="pin-editor-title">
        <div className="flex items-center justify-between border-b border-gray-200 p-5">
          <h3 id="pin-editor-title" className="text-lg font-semibold text-gray-800">
            {initial?.id ? "Edit Pin" : "Schedule a Pin"}
          </h3>
          <Button variant="ghost" onClick={onClose} aria-label="Close editor" size="sm">
            <i className="fas fa-times"></i>
          </Button>
        </div>
        <form onSubmit={handleSubmit} className="flex h-[calc(100%-80px)] flex-col">
...
const PinScheduler: React.FC = () => {
  const [pins, setPins] = useState<PinItem[]>(() => load<PinItem[]>("pins", []));
    ...
    <div>
      ...
      {sorted.length > 0 ? (
          ...
          {sorted.map((pin) => (
            <div key={pin.id} className="relative group">
              <div className="rounded-xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-lg">
                ...
                />
                <div className="p-4">
                  <h3 className="font-semibold text-gray-800 truncate">{pin.title}</h3>
        ...
        <Card className="text-center py-8">
          ...
          <p className="text-gray-600 mb-4">Get started by scheduling your first pin</p>
          <Button
    ...
    <>
      ...
      <SlideOver>
        <div className="flex items-center justify-between border-b border-gray-200 p-5">
          ...
          />
          <Button variant="ghost" onClick={onClose} aria-label="Close" size="sm">
            <i className="fas fa-times"></i>
          </Button>
        </div>
        <div className="flex h-[calc(100%-80px)] flex-col overflow-y-auto p-5">
          ...
          {pinScope === "specific" && (
            <div className="mb-6">
              <p className="text-sm text-gray-600 mb-2">Select pins to apply this rule to:</p>
            ...
            >
              <div className="flex items-start gap-3">
                <div className={cx(
                  ...
                  {trigger === "all_comments" && <i className="fas fa-check text-xs"></i>}
                </div>
                <div>
            ...
            >
              <div className="flex items-start gap-3">
                <div className={cx(
                  ...
                  {trigger === "specific_keywords" && <i className="fas fa-check text-xs"></i>}
                </div>
                <div>
          ...
          {trigger === "specific_keywords" && (
            <div className="mb-6">
              ...
              {keywords.length > 0 && (
                <div className="mt-3">
                  <p className="text-sm text-gray-600 mb-2">Keywords to trigger replies:</p>
          ...
          <p className="text-sm text-gray-600 mb-4">
            Add multiple reply variations. One will be chosen at random when triggered.
          </p>
    ...
    <div>
      ...
      {rules.length ? (
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                    <span className="flex items-center gap-1">
                      ...
                      {rule.pinScope === "all" ? "All Pins" : `${rule.pinIds.length} Pins`}
                    </span>
                    <span className="flex items-center gap-1">
        ...
        <Card className="text-center py-8">
          ...
          <h3 className="font-medium text-gray-800 mb-1">No automation rules</h3>
          <p className="text-gray-600 mb-4">Create rules to automatically reply to comments</p>
          <Button
      ...
      <div className="mx-auto max-w-7xl rounded-2xl bg-white p-6 shadow-xl">
        ...
        <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Pinterest Automation</h1>
              <p className="text-sm text-gray-600">Schedule pins and automate comments</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Card className="text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800">
              {pins.filter(p => p.scheduledAt && new Date(p.scheduledAt) > new Date()).length}
            </h3>
