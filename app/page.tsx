...
import { 
  Instagram, Zap, MessageSquare, ThumbsUp, 
  BarChart2, ShieldCheck, UserCheck, ChevronRight,
  Play, Check, Mail, Users, Smartphone, Settings,
  ArrowRight, Star, MessageCircle, User, CreditCard
} from 'lucide-react';
...
const InstagramAutomationLanding = () => {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'dark bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'} transition-colors duration-300`}>
      ...
      <nav className="fixed w-full z-50 py-4 px-6 backdrop-blur-md bg-white/80 dark:bg-gray-900/80">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#testimonials" className="hover:text-pink-500 transition-colors">Testimonials</a>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href='/Get-Start' className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded-lg font-medium hover:opacity-90 transition-opacity">
              Get Started
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600"> DMs & Comments</span>
            </motion.h1>
            ...
            >
              Save hours every day with our AI-powered automation tool that handles your Instagram DMs and comments while you focus on growing your business.
            </motion.p>
            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 flex items-center justify-center text-white font-bold border-2 border-white dark:border-gray-900">
                    {i}
                  </div>
                ))}
              </div>
              <p className="ml-4 text-gray-600 dark:text-gray-300">
                <span className="font-bold">5000+</span> businesses growing with InstaFlow
              </p>
            </motion.div>
          </div>
              ...
              <div className="space-y-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700 rounded-xl p-3 flex-1">
                      <div className="text-sm">Hey, I love your products! Do you offer discounts for bulk orders?</div>
                    </div>
                  </div>
                ))}
                ...
                <div className="flex justify-end">
                  <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl p-3 max-w-xs">
                    <div className="text-sm text-white">Thanks for reaching out! Yes, we offer discounts for orders over $500. I'll send you our catalog with pricing details.</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Automate Your Instagram Growth</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Our platform handles all aspects of Instagram engagement so you can focus on what matters most.
            </p>
          </motion.div>
      ...
      <section id="how-it-works" className="py-20 px-6 bg-gray-100 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Get started in minutes and automate your Instagram engagement today.
            </p>
          </motion.div>
      ...
      <section id="pricing" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Simple Plans for Every Business</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-20 px-6 bg-gray-100 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Trusted by Thousands of Creators</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto bg-gradient-to-r from-pink-500 to-purple-600 rounded-3xl p-12 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Automate Your Instagram?</h2>
            <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses saving time and growing their audience with InstaFlow.
            </p>
          ...
          <div className="grid md:grid-cols-5 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="mb-6 max-w-xs">
                Automate your Instagram DMs and comments to save time and grow your audience faster.
              </p>
...
const features = [
  {
    ...
    title: "DM Automation",
    description: "Automate responses to your Instagram direct messages with AI-powered replies.",
    bullets: [
  ...
  },
  {
    ...
    description: "Automatically respond to comments and engage with your audience.",
    bullets: [
  ...
  },
  {
    ...
    description: "Instagram-safe automation that follows all platform guidelines.",
    bullets: [
